...
@Module({
  ...
  providers: [RopService, RopProvisioningService, RopDocumentsService, RopMeetingsService, RopTasksService],
  exports: [RopService, RopProvisioningService, RopDocumentsService, RopMeetingsService, RopTasksService],
})
